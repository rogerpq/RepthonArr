...
class Config(object):
    ...
    # الفارات المطلوبة
    # هنا اسم حسابك
    ALIVE_NAME = os.environ.get("ALIVE_NAME", انور)
    # ايبيات حسابك احصل عليهن من موقع my.telegram.org
    APP_ID = int(os.environ.get("APP_ID", 18109107))
    API_HASH = os.environ.get("API_HASH", ) or e6afc7383da3a10fa16a0a9675c3e037
    # داتا بيس تلقائي من هيروكو او استخدم elepthntsql
    DB_URI = os.environ.get("DATABASE_URL", None)
    # كود تيرمكس باستخدام امر python3 stringsetup.py او من موقع https://replit.com/@taabn-tabantaba/Code-Telethon1
    STRING_SESSION = os.environ.get("STRING_SESSION", 1ApWapzMBuy4jolIM1Eccn0mfX6Jwf_w_iPRgtBpI1V1qoHM3By9dgkaryGX0iyAf8Bx_vFSenxDtxeCgNqRen185LEGGhz4Ki6VfTyqso5flrWuzNt8yidWIz3nCyoad8AnSeX9EjBAEvXexbjO30VBToA4RQlzntDkGorAQFfy37QKTOJ6BGQVljv_iAgPZ27zr_PvlliiG6VZIoHZwg4940wgMvhmGt4i36EUwFOJF5KxKzbFZm-4kdYYXu-M3_0zKbmkd6yC1rav7I4N2PgH3yLY-_K3S4jDnqzkNlrlZiY3EICxzWmX-icvFZujdbdkuozjkoJQu_izyO32I5_Gg0Zl17Jo=)
    # معرف و توكن بوتك
    TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", 5502331963:AAFxJ5vyAka0onxS-UnVFhN6-iO38-i8dUE) or os.environ.get(
    ...
    UPSTREAM_REPO = os.environ.get(
        "UPSTREAM_REPO", "https://github.com/rogerpq/RepthonAr"
    )
    # ملفات خارجيه اضافيه
